...
def s_fmap(function: Callable, arguments: Iterable, *args) -> tuple:
...
def s_argmap(functions: Iterable[Callable], arg: Any, *args) -> tuple:
    """Strict version of argmap()"""
    pass
...
def s_argzip(sequence: Iterable[Callable], arg: Any, *args) -> tuple:
    """strict version of argzip."""
    pass
